...
async def remove_abandoned_item(
    ...
    if payload.item_type not in ["cart", "wishlist"]:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid item_type. Must be 'cart' or 'wishlist'")
