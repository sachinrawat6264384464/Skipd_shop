...
export function RewardsBanner() {
  ...
  const referralCode = "E-COM-REF-9842";
  const [copied, setCopied] = useState(false);

  const copyReferral = () => {
    navigator.clipboard.writeText(`Use my referral code ${referralCode} to get ₹250 OFF on E-COM Commerce! https://e-com.vercel.app`);
    setCopied(true);
