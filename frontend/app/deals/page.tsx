...
export default function DealsPage() {
  ...
  const sampleDealProducts = [
    { id: 1, title: "Saree", price: 299, image: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=500", easyShip: true, weight: "<500gm", earlier: 71, now: 56, save: 15 },
    { id: 2, title: "Oil", price: 249, image: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=500", easyShip: true, weight: "1kg-2kg", earlier: 135, now: 120, save: 15 },
    { id: 3, title: "Cushion Cover", price: 800, image: "https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=500", easyShip: false, weight: "<500gm", earlier: 186, now: 107, save: 79 },
    { id: 4, title: "Power Bank", price: 999, image: "https://images.unsplash.com/photo-1609592424089-a2e4b3c4342d?w=500", easyShip: true, weight: "500gm-1kg", earlier: 264, now: 65, save: 199 },
    { id: 5, title: "Shoe", price: 700, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500", easyShip: true, weight: "500gm-1kg", earlier: 228, now: 120, save: 108 },
    { id: 6, title: "Jacket", price: 999, image: "https://images.unsplash.com/photo-1544441893-675973e31985?w=500", easyShip: false, weight: "1kg-2kg", earlier: 313, now: 134, save: 179 },
    { id: 7, title: "Toy drone", price: 999, image: "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=500", easyShip: true, weight: "500gm-1kg", earlier: 417, now: 118, save: 299 },
    { id: 8, title: "Headphone", price: 950, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500", easyShip: false, weight: "500gm-1kg", earlier: 263, now: 98, save: 165 },
  ];

  const productsToDisplay = sale?.products?.length > 0
  ...
  return (
    <div className="bg-[#FAFAFA] text-gray-900 min-h-screen flex flex-col justify-between">
      <div className="w-full space-y-8 pb-12">
        ...
        {/* 🟠 Hero Sale Banner (Matching Reference Screenshot 3) */}
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 max-w-2xl z-10">
              ...
              <div className="pt-2">
                <Link
                  href="/search"
                  className="inline-block bg-gray-900 hover:bg-black text-white font-black text-sm px-8 py-3.5 rounded-2xl transition shadow-lg shadow-black/20"
                >
        ...
        {/* 📦 "Get Great Freedom Sale Ready" Feature Cards (Matching Reference Screenshot 3) */}
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-black text-center text-gray-900 mb-6">Get Great Freedom Sale Ready</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-amber-50/60 border border-orange-200 rounded-3xl p-6 shadow-xs text-center space-y-3 relative overflow-hidden">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                Get your products in front of customers across 100% of India's serviceable pin codes with Shiprocket logistics.
              </p>
            </div>
            ...
            <div className="bg-amber-50/60 border border-orange-200 rounded-3xl p-6 shadow-xs text-center space-y-3 relative overflow-hidden">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                Fee explainer &amp; revenue calculator gives complete visibility into your fees, discounts, and net margins.
              </p>
            </div>
            ...
            <div className="bg-amber-50/60 border border-orange-200 rounded-3xl p-6 shadow-xs text-center space-y-3 relative overflow-hidden">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                Create listings, generate A+ content, and get growth insights with SKIPD Assistant AI listing creator.
              </p>
            </div>
          </div>
        </div>

        {/* 🖤 "With Zero Referral Fees, Every Sale Event Order Delivers More" (Matching Reference Screenshot 4) */}
        <div className="bg-[#0f172a] text-white py-12 px-6 shadow-lg">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            <h2 className="text-2xl md:text-3xl font-black tracking-tight">
              With Zero Referral Fees, Every Sale Event Order Delivers More
            </h2>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-4 text-xs">
              <div className="space-y-2 flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-orange-500 text-white font-black text-xs flex items-center justify-center shadow-lg shadow-orange-500/30">
                  Zero
                </div>
              ...
              <div className="space-y-2 flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-amber-500 text-white font-black text-xl flex items-center justify-center shadow-lg shadow-amber-500/30">
                  📦
                </div>
              ...
              <div className="space-y-2 flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-emerald-500 text-white font-black text-xl flex items-center justify-center shadow-lg shadow-emerald-500/30">
                  📉
                </div>
              ...
              <div className="space-y-2 flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-blue-500 text-white font-black text-xl flex items-center justify-center shadow-lg shadow-blue-500/30">
                  🚚
                </div>
        ...
        {/* 🛍️ Dynamic Freedom Sale Deals Product Grid (Matching Reference Screenshot 5) */}
        <div className="max-w-6xl mx-auto px-4 pt-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/search" className="text-xs font-bold text-orange-600 hover:underline">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {productsToDisplay.map((item: any) => (
              <div
                key={item.id}
                className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-xs hover:shadow-xl transition duration-300 flex flex-col justify-between p-4 space-y-3 group"
              >
                {/* Product Image */}
                ...
                <BuyNowButton
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-black py-2.5 rounded-2xl text-center transition flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
                >
