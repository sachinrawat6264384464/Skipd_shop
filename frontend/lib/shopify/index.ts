...
export async function createCart(): Promise<Cart> {
  if (!endpoint) {
    return {
      ...
      cost: { subtotalAmount: { amount: "0", currencyCode: "INR" }, totalAmount: { amount: "0", currencyCode: "INR" }, totalTaxAmount: { amount: "0", currencyCode: "INR" } },
      lines: [],
      totalQuantity: 0
    };
  }
